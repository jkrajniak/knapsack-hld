...
def _emit_combined_table(rows: list[dict[str, str]]) -> str:
    """One median-focused HLD-vs-all-baselines table grouped by algorithm."""
    header = [
    ...
    body: list[str] = []
    for baseline, label in COMBINED_ORDER:
